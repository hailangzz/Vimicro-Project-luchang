...
origin_train_path = r'/home/zhangzhuo/git_workspace/yolov5/datasets/extract_detect_car_brand/train'
save_val_path = r'/home/zhangzhuo/git_workspace/yolov5/datasets/extract_detect_car_brand/val'

def create_val_dataset(val_rate=0.02,move_flag = False):
