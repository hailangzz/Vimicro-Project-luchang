...
model_quant_static = 'models/arcface_quant_static.onnx'
...
'''
    读取图像 -> 预处理 -> 组成数据字典
'''
img_dir = r'F:\AiTotalDatabase\ADAS_test_images\origin_images1'
img_num = 5
datas = [
    val_transforms(
...
quantize_static(
    ...
    quant_format=QuantFormat.QOperator,  # 量化格式 QDQ / QOperator   !!!注此处如果用QDQ的话会报list()错误！！！
