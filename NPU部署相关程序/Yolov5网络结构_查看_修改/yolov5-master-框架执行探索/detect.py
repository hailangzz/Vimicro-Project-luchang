...
def run(
        weights=ROOT / 'yolov5s.pt',  # models path or triton URL
    ...
    if update:
        strip_optimizer(weights[0])  # update models (to fix SourceChangeWarning)


def parse_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5s.pt', help='models path or triton URL')
