...
origin_sample_path = r"D:\迅雷下载\AI数据集汇总\汽车拍照检测识别\CCPD_rec_images\train\images"
trainfiles = os.listdir(origin_sample_path)  #（图片文件夹）
# print(trainfiles)

trainDir_strengthen = r"D:\迅雷下载\AI数据集汇总\汽车拍照检测识别\CCPD_rec_images_strengthen"   #（将图片文件夹中的6份放在这个文件夹下）
...
def add_province_car_number_info(strengthen_num = 10000):
