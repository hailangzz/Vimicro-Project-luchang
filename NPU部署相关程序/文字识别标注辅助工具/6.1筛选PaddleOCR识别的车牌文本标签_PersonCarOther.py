...
save_deal_rec_fill_path=r'D:\迅雷下载\AI数据集汇总\汽车拍照检测识别\detect_car_brand_crops\all_detect_crops_database_labels_file\detect_PersonCarOther_car_brand_crops_focus_8_pt_labels.txt'
save_rec_cur = open(save_deal_rec_fill_path,'w',encoding='utf-8')

rec_file_path = r'D:\PycharmProgram\PaddleOCR-release-2.5\inference_results\rec_results_PersonCarOther.txt'
