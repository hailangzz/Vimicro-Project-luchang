...
class BlazeFace(nn.Module):
    ...
    def pth2onnx(self, path):  # 在load_weights和load_anchors之间添加，当然也可以随便在class里随意位置添加
        ...
        torch_out = torch.onnx.export(self, x, "blazeface.onnx", export_params=True, verbose=False,opset_version=11,input_names=input_names,output_names=output_names)
        self.eval()
...
# py文件最末尾
model_path = r"E:\BlazeFace-PyTorch-master\blazeface.pth"
bf = BlazeFace()
bf.pth2onnx(model_path)
onnx_model_simplify(origin_onnx_model_path="blazeface.onnx")
