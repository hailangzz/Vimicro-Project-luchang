...
model.load_state_dict(torch.load(r'D:\中星微人工智能工作\Total_Models\yolov5-LPRNet-车牌检测识别/runsLPRNet__iteration_60000.pth', map_location=device))
model.eval()
...
torch.onnx.export(model, x, 'LPNNet_74.onnx', input_names=input_names, output_names=output_names, verbose='True',opset_version=12)