...
from models.LPRNet_My74 import CHARS, LPRNet
...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', default=r'D:\中星微人工智能工作\Total_Models\yolov5-LPRNet-车牌检测识别/runsLPRNet__74char_best.pth', help='pretrained base models')
