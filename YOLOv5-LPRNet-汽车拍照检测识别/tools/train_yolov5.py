...
import test_yolov5  # import test_yolov5.py to get mAP after each epoch
...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            results, maps, times = test_yolov5.test(opt.data,
    ...
    for f1, f2 in zip([wdir + 'yolov5_best.pt', wdir + 'best.pt', 'results.txt'], [flast, fbest, fresults]):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', const='get_last', default=False,
                        help='resume from given path/to/yolov5_best.pt, or most recent run if blank.')
