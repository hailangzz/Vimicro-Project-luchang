...
class Colors:
    ...
    def __init__(self):
        ...
        # 红 浅红 橘色 黄色 - 浅绿     'FF37C7' 'FF3838', 'FF9D97'这三个是红色 暂时去掉
        hex = ('FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
               '2C99A8', '00C2FF', '344593', '6473FF', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8')
