...
class create_car_person_plate_sample:
    ...
    def check_image_with_wh_pixel_rate(self,coco_box_info,w_rate=0.01):
    ...
    def get_single_label_file_info(self,label_cur):
    ...
    def check_target_labels(self,max_images_number=200):
        ...
        for single_label_name in all_labels_name_list:
            ...
            total_label_info_dict=self.get_single_label_file_info(now_lable_cur)
                ...
                for index, point_box in enumerate(total_label_info_dict['point_box']):
                    ...
                    if self.Bool_operate_set_dict['Is_check_pixle']:
                        ...
                        if check_pixle_flag: #当像素点符合W 比例限制时。
                            ...
                            if total_label_info_dict['classify_num'][index] in ['0', '1']:  # preson类别
                                write_label_cur.write('0'+' '+point_box)
                            elif total_label_info_dict['classify_num'][index] in ['2','3','4']: # car类别
                                write_label_cur.write('1' + ' ' + point_box)
