...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    last, best = w / 'last.pt', w / 'car_brand.pt'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_focus_p3.yaml', help='models.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/car_band_real.yaml', help='dataset.yaml path')
