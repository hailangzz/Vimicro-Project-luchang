...
class cut_image_from_vidoe():
    ...
    def __init__(self):
        self.origin_vidoe_path = r"D:\迅雷下载\AI数据集汇总\Vimicro_DVR_Dataset\Vimicro_Vidoe_dataset"
        self.total_vidoe_path_list = os.listdir(self.origin_vidoe_path)
        self.save_path = r'D:\迅雷下载\AI数据集汇总\Vimicro_DVR_Dataset\Vimicro_Image_dataset'
